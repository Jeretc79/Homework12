...
var orm = {
    ...
    // Team structure information : role with corresponding daprtment
    getTeamStruct() {
        return new Promise(resolve => {
            connection.query(queryCollection.viewTeamStruct, function (err, res) {
                if (err) throw err;
                let companyData = new Object(); // to save the role and department data, since they are set
    ...
    getListOfDept() {
        return new Promise(resolve => {
            connection.query(queryCollection.viewListOfDept, function (err, res) {
                if (err) throw err;
                let listDept = [];
                for (var i = 0; i < res.length; i++) {
    ...
    // A list of current manager's full name
    getListOfManager() {
        return new Promise(resolve => {
            connection.query(queryCollection.viewListOfManager, function (err, res) {
                if (err) throw err;
                let listManager = [];
                for (var i = 0; i < res.length; i++) {
                    listManager.push(res[i].id + "." + res[i].Manager);
                }
                resolve(listManager);
            });
        });
    ...
    getListOfRole() {
        return new Promise(resolve => {
            connection.query(queryCollection.viewListOfRole, function (err, res) {
                if (err) throw err;
                let listRole = [];
                for (var i = 0; i < res.length; i++) {
    ...
    getListOfAllName() {
        return new Promise(resolve => {
            connection.query(queryCollection.viewListOfAllName, function (err, res) {
                if (err) throw err;
                let listName = ["None"];
                for (var i = 0; i < res.length; i++) {
    ...
    viewDepartBudget(cb, listDept) {
        inquirer.prompt({
            ...
            .then(function (userPick) {
                ...
                connection.query(queryCollection.viewDepartBudget + addOnQuery, [userPick.department], function (err, res) {
                    if (err) throw err;
                    console.table(res);
                    cb();
                });
    ...
    viewEmployDetail(cb) {
        connection.query(queryCollection.viewEmployDetail, function (err, res) {
            if (err) throw err;
            console.table(res);
            cb();
        });
    ...
    viewEmployeeByDept(cb, listDept) {
        inquirer.prompt({
            ...
            .then(function (userPick) {
                ...
                connection.query(queryCollection.viewEmployDetail + addOnQuery, [userPick.department], function (err, res) {
                    if (err) throw err;
                    console.table(res);
                    cb();
                });
    ...
    viewEmployeeByManager(cb, listManager) {    //with manager himself
        inquirer.prompt({
            ...
            .then(function (userPick) {
                ...
                connection.query(queryCollection.viewEmployDetail + addOnQuery, [managerId, managerId], function (err, res) {
                    if (err) throw err;
                    console.table(res);
                    cb();
                });
    ...
    addEmployee(cb, listRole, listName) {
        inquirer.prompt([
            ...
            .then(async function (data) {
                ...
                connection.query(queryCollection.insertNewEmployee, [firstName, lastName, role_id, manager_id], function (err, res) {
                    if (err) throw err;
        ...
        inquirer.prompt({
            ...
            .then(function (data) {
                if (data.remove_employee === "None") cb();
                    ...
                    connection.query(queryCollection.removeEmpolyee + addOnQuery, [remove_employee_id], function (err, res) {
                        if (err) throw err;
                        console.log("ID:" + remove_employee_id + " employee was removed!!!");
                        let addOnQuery = ` set manager_id = null where manager_id = ?`
                        connection.query(queryCollection.updateEmplyee + addOnQuery, [remove_employee_id], function (err, res) {
                            if (err) throw err;
        ...
        inquirer.prompt([
            ...
            .then(function (data) {
                if (data.employee === "None") cb();
                    ...
                    connection.query(queryCollection.viewEmployDetail + addOnQuery, [updateNameId], function (err, res) {
                        if (err) throw err;
    ...
    updateRoleNext(cb, updateNameId, updateRole) {
        let addOnQuery = ` where title = ?`;
        connection.query(queryCollection.viewTeamStruct + addOnQuery, [updateRole], function (err, res) {
            if (err) throw err;
            let updatRoleId = res.id;
            let addOnQuery = ` set role_id = ? where employee.id = ?`;
            connection.query(queryCollection.updateEmplyee + addOnQuery, [updateRole, updateNameId], function (err, res) {
                if (err) throw err;
                console.log("ID:" + updateNameId + "'s role was updated to " + updateRole);
                cb();
            })
        })
    },
            ...
            .then(function (data) {
                if (data.employee === "None") cb();
                    ...
                    if (pickManagerId === pickNameId) {
                        ...
                        connection.query(queryCollection.updateEmplyee + addOnQuery, [pickManagerId, pickNameId], function (err, res) {
                            if (err) throw err;
